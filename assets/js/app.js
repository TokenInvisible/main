...
let addr;
const sttaddr = "0x97758d573Dedf4A64568dcEee3649C7F1789921a";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x97758d573Dedf4A64568dcEee3649C7F1789921a";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://invisibletoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x97758d573Dedf4A64568dcEee3649C7F1789921a',
                    'symbol': 'IVS',
                    'decimals': '5',
                    'image': 'https://invisibletoken.net/images/logo.png',
                },
            },
